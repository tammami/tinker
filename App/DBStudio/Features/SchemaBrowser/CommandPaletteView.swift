...
public struct CommandPaletteView: View {
    ...
    private var allCommands: [PaletteCommand] {
        ...
        let actions: [(String, String, String?, @MainActor () -> Void)] = [
            ...
            ("Run Statement or Selection", Icon.run, "⌘↩", { controller.run(all: false) }),
            ("Run Selected", Icon.run, "⌘⌥↩", { controller.runSelection() }),
            ("Run All", Icon.runAll, "⌘⇧↩", { controller.run(all: true) }),
            ...
            ("Rollback", Icon.rollback, "⌘⇧R", { controller.rollback() }),
            ("Refresh", Icon.refresh, "⌘R", { controller.refresh() }),
