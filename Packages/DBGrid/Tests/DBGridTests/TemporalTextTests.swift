...
final class TemporalTextTests: XCTestCase {
    func testTimestampWithFractionAndOffsetRoundTrips() throws {
        ...
        XCTAssertEqual(TemporalText.render(parts.date, kind: .timestamp, fraction: parts.fraction, offset: parts.offset), text)
    ...
    func testMySQLDatetimeWithoutZoneAndISOFormRoundTrip() throws {
        ...
        XCTAssertEqual(TemporalText.render(plain.date, kind: .timestamp, fraction: "", offset: ""), "2026-03-21 20:23:26")
        let iso = try XCTUnwrap(TemporalText.parse("2026-03-21T20:23:26Z", kind: .timestamp))
        XCTAssertEqual(iso.offset, "Z")
        XCTAssertEqual(TemporalText.render(iso.date, kind: .timestamp, fraction: "", offset: "Z"), "2026-03-21 20:23:26Z")
    }
    ...
    func testDateAndTimeKinds() throws {
        ...
        XCTAssertEqual(TemporalText.render(time.date, kind: .time, fraction: time.fraction, offset: time.offset), "02:30:00.5+07")
