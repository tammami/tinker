...
public enum MaintenanceAction: String, Sendable, Hashable, CaseIterable, Codable {
    ...
    public var summary: String {
        ...
        case .vacuum: "Reclaims space left by updated and deleted rows."
...
public enum TableOperations {
    /// `ALTER TABLE … RENAME TO` on PostgreSQL, `RENAME TABLE` on MySQL.
    ...
    /// which is what a person duplicating a table for an experiment wants.
